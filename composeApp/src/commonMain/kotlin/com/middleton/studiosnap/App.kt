...
fun App() {
    ...
    val navigationHandler = koinInject<NavControllerNavigationHandler>()
    ...
    StudioSnapTheme {
        NavHost(
            ...
            addOnboardingScreen()
            addHomeScreen()
            addStylePickerScreen(navController)
            addProcessingScreen()
            addResultsScreen()
...
private fun NavGraphBuilder.addStylePickerScreen(navController: androidx.navigation.NavHostController) {
